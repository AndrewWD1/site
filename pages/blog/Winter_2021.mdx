...
<Image src={butler} className={styles.image} alt="Butler Gulch" />
...
<Image src={berthoud} className={styles.image} alt="Berthoud Pass" />
...
<Image src={noname} className={styles.image} alt="No Name Bench" />
...
<Image src={breck1} className={styles.image} alt="Breck" />

<Image src={breck2} className={styles.image} alt="Breck" />
