...
Still feeling good we took a quick break for a snack and then started booting up the couloir. This had me absolutely gassed. But we got up in fairly good time, and got some fabulous turns on the way down as the soft snow was just beginning to get a bit heavy from the sun.
...
It was one of the harder backcountry lines I have skied so far, but felt cruiser and it was a lot of fun. Warm temps meant gettting back to trailhead was tough though, since now the snow was very sun affected below Blue Lake. All in all took about 8.5 hours.
...
<Image src={banana} className={styles.image} alt="Banana Bowls"  placeholder="blur"/>
...
<Image src={banana2} className={styles.image} alt="Banana Bowls"  placeholder="blur"/>
...
<Image src={mines} className={styles.image} alt="Mines Peak"  placeholder="blur"/>

<Image src={mines2} className={styles.image} alt="Mines Peak"  placeholder="blur"/>
...
<Image src={james1} className={styles.image} alt="James Peak"  placeholder="blur"/>

<Image src={james2} className={styles.image} alt="James Peak"  placeholder="blur"/>
...
<Image src={ros} className={styles.image} alt="Rosalie Peak"  placeholder="blur"/>
...
<Image src={ros2} className={styles.imageVert} alt="Rosalie Peak"  placeholder="blur"/>
...
<Image src={ros3} className={styles.imageVert} alt="Rosalie Peak"  placeholder="blur"/>
...
<Image src={ros4} className={styles.image} alt="Rosalie Peak"  placeholder="blur"/>
...
<Image src={bas} className={styles.imageVert} alt="Bastille"  placeholder="blur"/>
...
<Image src={ved} className={styles.image} alt="Vedauwoo"  placeholder="blur"/>
