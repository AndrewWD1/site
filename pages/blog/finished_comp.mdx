...
<Image src={tr} className={styles.imageVert} alt="Turkey Rocks"  placeholder="blur"/>
...
<Image src={humboldt} className={styles.image} alt="Humboldt Trip"  placeholder="blur"/>
<Image src={humboldt1} className={styles.image} alt="Humboldt Trip" placeholder="blur"/>

<Image
  src={southplatte}
  className={styles.image}
  alt="Fishing a beautiful high country stream" 
  placeholder="blur"
/>
...
<Image
  src={grays}
  className={styles.image}
  alt="Nice late ski trip on Grays Peak"
  placeholder="blur"
/>
...
<Image
  src={icicle}
  className={styles.image}
  alt="Looking up Icile Creek Road" 
  placeholder="blur"
/>
<Image src={estu} className={styles.image} alt="Squamish Estuary"  placeholder="blur"/>
<Image src={estu1} className={styles.image} alt="Squamish Estuary" placeholder="blur" />
<Image src={camp} className={styles.image} alt="Squamish Camping spot" placeholder="blur" />

<Image src={coon} className={styles.image} alt="Hiking with Sierra" placeholder="blur" />
<Image src={hessie} className={styles.image} alt="Hiking with Sierra" placeholder="blur" />
