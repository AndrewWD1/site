...
const musicRows = [
  ...
  [
    "2",
    <a href="https://www.youtube.com/watch?v=35iZSbmRie8">And Then I Knew</a>,
    "Pat Metheny Group",
  ],
  [
    "3",
    <a href="https://www.youtube.com/watch?v=LM9UUKwJ7Z8">Rye Lane Shuffle</a>,
    "Moses Boyd",
  ],
  [
    "4",
...
export const MusicTable = () => (
  <GeneralTable head={["#", "Song", "Artist"]} rows={musicRows} />
);

export const BookTable = () => (
  <GeneralTable head={["#", "Title", "Author"]} rows={bookRows} />
);
